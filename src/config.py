##### Config file for Lisft-splat + PointPillars with TransFuser #####

class LPTConfig:


    train_label = 'drivable_area' #'vehicle' 'drivable_area' 'walkway' 'lane_divider'
    print('Config label: ', train_label)
